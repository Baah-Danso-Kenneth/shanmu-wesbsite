  ...
  return (
    <section className="relative w-full bg-white flex flex-col md:flex-row min-h-[600px]">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-6 md:px-24 py-20">
        <h2 className="text-4xl md:text-6xl font-black text-[#1c1c1c] mb-8 leading-tight tracking-tighter uppercase">
          For the <br /> Market Icons.
        </h2>
        <p className="max-w-md text-[#1c1c1c]/70 font-mono text-sm md:text-base leading-relaxed mb-12">
          A curated selection of imports based strictly on your vision. From high-end tech to artisanal fashion, we bridge the gap between global manufacturers and your doorstep.
        </p>
